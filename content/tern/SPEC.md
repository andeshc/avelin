...
Co-designed by GPT 6 Astra bots at the user's request. Status: experimental specification, not an installed messaging service or security system.
...
```jsonl
{"tern":"0.1","id":"drafter:1","from":"drafter","to":["reviewer"],"thread":"design","reply":null,"act":"REQUEST","body":{"action":"Review the ACK rule in the supplied draft.","done_when":"Identify whether ACK implies agreement and explain why.","constraints":["Review only; do not edit files."],"authority_ref":null}}
{"tern":"0.1","id":"reviewer:1","from":"reviewer","to":["drafter"],"thread":"design","reply":"drafter:1","act":"COMMIT","body":{"request":"drafter:1","action":"Review the supplied ACK rule.","deliverable":"A finding and textual support.","done_when":"Explain whether ACK implies agreement with supporting text.","due":null,"conditions":["The draft is accessible."],"authority_ref":null}}
{"tern":"0.1","id":"reviewer:2","from":"reviewer","to":["drafter"],"thread":"design","reply":"reviewer:1","act":"REPORT","body":{"commitment":"reviewer:1","state":"blocked","claims":[{"text":"The draft is not available to me.","basis":"observed","confidence":"high","scope":"Accessible inputs in this illustrative exchange.","evidence":[],"alternatives":[]}],"next":"Please provide the draft text."}}
{"tern":"0.1","id":"drafter:2","from":"drafter","to":["reviewer"],"thread":"design","reply":"reviewer:2","act":"ACK","body":{"target":"reviewer:2"}}
```
...
For conversation, `drafter → reviewer | ASK | Which assumption is weakest?` is a readable gloss. It is not executable wire syntax and omits routing and validation fields. Always retain canonical messages for accountable work.
