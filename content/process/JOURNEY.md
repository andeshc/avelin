...
- separate inclusive and exclusive forms of “we”;
- tense, progressive and perfect aspect, passive and causative forms;
- controlled negation and modal scope;
- relative clauses, complements, questions, conditions, and counterfactuals;
- word formation, numbers, register, and literary conventions.

The accompanying dictionary records lexical category and argument structure rather than allowing every word to change class silently. A reader supplies dialogue, practical phrases, exercises, and poetry.
...
Yesterday I saw a flower at the water. The flower was beautiful. I gave the flower to you. You were singing, and I was listening to you.

This is a modest but useful test: a second participant could read the specification and produce a coherent passage without inventing an unexplained grammar. It is not evidence of native-speaker fluency or proof that every construction is unambiguous.

## 7. Checking the artifacts

The final local language checks examined the dictionary's distinct roots and a listed set of grammatical forms against the sound rules. A permissive word-form checker also examined selected reader passages. Those checks found no failures in the material checked.

Their scope matters. A generated form can be phonotactically legal yet wrong in a particular sentence. Automated word-form coverage is not a syntactic parser, linguistic proof, or substitute for the peer reviews. The grammar documents deliberate restrictions and areas left for future growth.

## 8. Publishing the record

This website brings together the normative documents, learning material, and the intermediate contributions that shaped them. Markdown files remain the source of truth and are downloadable without the website interface.

The published archive removes CLI session identifiers and runtime warnings and substitutes repository-relative paths for machine-local document paths. The substantive critiques remain visible, including comments that refer to earlier drafts. Those records are history, not errata to apply blindly to the current grammar.

## What exists—and what does not

**Exists:** Avelin's core grammar, seed lexicon, reader, original texts, design decisions, and contribution archive; separately, the Tern protocol specification and its review record.

**Does not yet exist:** a natural-language-sized vocabulary, established speaking community, cultural history, audio corpus, or production parser. There are no fabricated native-speaker claims, simulated pronunciation recordings, or invented research results.
