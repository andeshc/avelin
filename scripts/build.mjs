...
const order = ['avelin/READER','avelin/GRAMMAR','avelin/LEXICON','process/JOURNEY','process/DECISIONS','process/LANGUAGE-PROPOSAL','process/LANGUAGE-REVIEW','process/LANGUAGE-FINAL-REVIEW','tern/SPEC','process/TERN-PROPOSAL','process/TERN-REVIEW','process/TERN-FINAL'];
const labels = {'avelin/READER':'Reading & speaking','avelin/GRAMMAR':'Reference grammar','avelin/LEXICON':'Core lexicon','process/JOURNEY':'The creation journey','process/DECISIONS':'Design decisions','process/LANGUAGE-PROPOSAL':'Language proposal','process/LANGUAGE-REVIEW':'Grammar review','process/LANGUAGE-FINAL-REVIEW':'Final language review','tern/SPEC':'Tern specification','process/TERN-PROPOSAL':'Tern proposal','process/TERN-REVIEW':'Tern review','process/TERN-FINAL':'Tern final review'};
